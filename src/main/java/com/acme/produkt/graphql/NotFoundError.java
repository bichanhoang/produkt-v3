...
class NotFoundError implements GraphQLError {
    ...
    public String getMessage() {
        return id == null
            ? "Kein Produkt gefunden: suchkriterien=" + suchkriterien
            : "Kein Produkt mit der ID " + id + " gefunden";
    }

    /**
     * Keine Angabe von Zeilen- und Spaltennummer der GraphQL-Query, falls kein Produkt gefunden wurde.
     *
     * @return null.
     */
    @Override
