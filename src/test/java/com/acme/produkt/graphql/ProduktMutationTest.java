...
import static com.acme.produkt.graphql.ProduktQueryTest.GRAPHQL_PATH;
import static com.acme.produkt.graphql.ProduktQueryTest.HOST;
import static com.acme.produkt.graphql.ProduktQueryTest.ID_PATTERN;
import static com.acme.produkt.graphql.ProduktQueryTest.PASSWORD;
import static com.acme.produkt.graphql.ProduktQueryTest.SCHEMA;
import static com.acme.produkt.graphql.ProduktQueryTest.USER_ADMIN;
...
class ProduktMutationTest {
    private final HttpGraphQlClient client;

    @InjectSoftAssertions
    private SoftAssertions softly;

    ProduktMutationTest(@LocalServerPort final int port, final ApplicationContext ctx) {
