...
import static com.acme.produkt.entity.Adresse.PLZ_PATTERN;
...
class ProduktQueryTest {
    ...
    ProduktQueryTest(@LocalServerPort final int port, final ApplicationContext ctx) {
    ...
    class FindById {
        ...
        void findById(final CharSequence id) {
            ...
            final var nachname = response.field("produkt.nachname").toEntity(String.class);
            softly.assertThat(nachname)
                .isNotEmpty()
                .matches(NAME_PATTERN);

            final var email = response.field("produkt.email").toEntity(String.class);
            softly.assertThat(email)
                .isNotEmpty()
                .contains("@");

            final var plz = response.field("produkt.adresse.plz").toEntity(String.class);
